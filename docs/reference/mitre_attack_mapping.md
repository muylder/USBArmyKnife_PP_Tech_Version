...
**Intelligence Report ID:** GHOST-INT-2025-001
...
This device effectively weaponizes physical proximity, bypassing perimeter defenses and neutralizing air gaps.
...
| **Credential Access** | **T1557** | **Adversary-in-the-Middle** | USB Ethernet mode captures traffic; Wi-Fi "Evil Portal" captures credentials. |
