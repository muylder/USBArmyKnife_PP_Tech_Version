...
## Active Tasks
- [x] Add Pentest Features:
    - [x] **USBHID**: Implement `getLEDState` to read Caps/Num Lock status from host.
    - [x] **DuckyScript**: Add `WAIT_FOR_CAPS_CHANGE`, `WAIT_FOR_CAPS_ON`, `WAIT_FOR_CAPS_OFF`.
- [x] Add Pentest Features:
    - [x] **USBHID**: Implement `getLEDState` to read Caps/Num Lock status from host.
    - [x] **DuckyScript**: Add `WAIT_FOR_CAPS_CHANGE`, `WAIT_FOR_CAPS_ON`, `WAIT_FOR_CAPS_OFF`.
